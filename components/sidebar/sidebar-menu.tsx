...
export const SidebarMenu = React.memo<SidebarMenuProps>(({ 
  className, 
  ...props 
}) => {
  return (
...
export const SidebarMenuAction = React.memo<SidebarMenuActionProps>(({ 
  className, 
  asChild = false, 
  showOnHover = false, 
  ...props 
...
export const SidebarMenuBadge = React.memo<SidebarMenuBadgeProps>(({ 
  className, 
  ...props 
}) => {
  return (
...
export const SidebarMenuSkeleton = React.memo<SidebarMenuSkeletonProps>(({ 
  className, 
  showIcon = false, 
  ...props 
}) => {
...
export const SidebarMenuSub = React.memo<SidebarMenuSubProps>(({ 
  className, 
  ...props 
}) => {
  return (
...
export const SidebarMenuSubItem = React.memo<SidebarMenuSubItemProps>(({ 
  className, 
  ...props 
}) => {
  return (
...
export const SidebarMenuSubButton = React.memo<SidebarMenuSubButtonProps>(({ 
  asChild = false, 
  size = 'md', 
  isActive = false, 
  className, 
