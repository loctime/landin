...
export const SidebarGroup = React.memo<SidebarGroupProps>(({ 
  className, 
  ...props 
}) => {
  return (
...
export const SidebarGroupLabel = React.memo<SidebarGroupLabelProps>(({ 
  className, 
  asChild = false, 
  ...props 
}) => {
...
export const SidebarGroupAction = React.memo<SidebarGroupActionProps>(({ 
  className, 
  asChild = false, 
  ...props 
}) => {
...
export const SidebarGroupContent = React.memo<SidebarGroupContentProps>(({ 
  className, 
  ...props 
}) => {
  return (
